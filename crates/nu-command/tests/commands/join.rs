    ...
    for ((left, right, on), join_types) in [
        ...
        (
            ...
            [
                ...
                ("--left", "[[a, ref, b]; [1, 1, 1], [2, 2, 2], [3, null, null]]"),
                ("--right", "[[a, ref, b]; [1, 1, 1], [2, 2, 2], [null, 3, 3]]"),
                ("--outer", "[[a, ref, b]; [1, 1, 1], [2, 2, 2], [3, null, null], [null, 3, 3]]"),
            ],
        ),
        (
            ...
            [
                ("--inner", "[[a, ref, b]; [1, 1, 1], [2, 2, 2]]"),
                ("--left", "[[a, ref, b]; [1, 1, 1], [2, 2, 2], [3, 3, null]]"),
                ("--right", "[[a, ref, b]; [1, 1, 1], [2, 2, 2], [null, null, 3]]"),
                ("--outer", "[[a, ref, b]; [1, 1, 1], [2, 2, 2], [3, 3, null], [null, null, 3]]"),
            ],
        ),
    ] {
